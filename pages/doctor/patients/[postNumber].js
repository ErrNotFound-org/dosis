            ...
            <div className="flex m-[15px] justify-center items-center">
              ...
              <div className="overflow-y-scroll h-[150px] w-3/4">
                <h2 className="font-bold font-raleway text-[20px] mt-[20px]">
                  ...
                  eligendi non cum necessitatibus cupiditate ratione praesentium
                  ipsum. Consequatur expedita quibusdam reiciendis ipsam vero
                  atque inventore ipsum accusamus laboriosam nulla. Odit id
                  consequuntur praesentium quia ea ratione? Repellendus sequi
                  quis, voluptas doloribus laudantium sit.
                </h2>
              </div>
            </div>
            ...
            <div className="flex m-[25px] justify-center items-center mt-[25px]">
              ...
              <div className="overflow-y-scroll h-[250px] w-3/4">
                <h2 className="font-bold font-raleway text-[20px] mt-[20px] ">
                  ...
                  veniam ratione deleniti quas dignissimos, repellendus mollitia
                  saepe expedita dolores ducimus quisquam! Earum magnam, iste
                  aut nobis corporis, cum enim cumque in distinctio eaque
                  dignissimos. Voluptates sed, nostrum quibusdam laborum labore,
                  vero laudantium obcaecati provident unde alias esse voluptate!
                  Totam veritatis sed ut fugit fuga, maiores saepe amet quia
                  molestiae eligendi doloribus, beatae temporibus sit hic velit
                  et debitis. Unde fugit quisquam perspiciatis voluptatum
                  deserunt officia. Eligendi culpa alias impedit ipsam sequi
                  quidem a sed dicta beatae quo fuga, nihil libero ratione qui
                  est accusantium rem cum iusto odio maxime reiciendis numquam
                  necessitatibus dolore voluptatem! Ratione, ipsum possimus?
                  Quaerat consectetur nesciunt officia magni obcaecati, illum
                  laboriosam tempora, vel exercitationem optio repellat esse
                  rem, dolor voluptatibus eius provident excepturi. Minus
                  aperiam ipsa non nisi molestias delectus voluptate cupiditate
                  facilis incidunt?
                </h2>
              </div>
            </div>
